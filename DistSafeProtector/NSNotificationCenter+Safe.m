...
//        NSException *exception=[NSException exceptionWithName:@"dealloc时通知中心未移除本对象" reason:[NSString stringWithFormat:@"dealloc时通知中心未移除本对象  Class:%@",[self class]] userInfo:nil]; DistSafeProtectionCrashLog(exception,DistSafeProtectorCrashTypeNSNotificationCenter);
